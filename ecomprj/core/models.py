...
class Category(models.Model):
    ...
    title = models.CharField(max_length=100, default="Pendrive")
...
class Product(models.Model):
    ...
    vendor = models.ForeignKey(
        Vendor, on_delete=models.CASCADE, related_name="product")
    brand=models.ForeignKey(Brand,on_delete=models.CASCADE)

    title = models.CharField(max_length=100, default="Usb")
    image = models.ImageField(
    ...
    type = models.CharField(
        max_length=100, default="Pendrive", null=True, blank=True)
