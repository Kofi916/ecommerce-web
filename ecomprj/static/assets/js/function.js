...
//     paymentForm.addEventListener("onclick", payWithPaystack);
...
//             alert(message);
//             window.location.href ="{% url 'verify_payment' %}";
...
//     let plan = "";
//     const userMail = document.getElementById("email").value;
//     const price = document.getElementById("amount").value*100;
//     const MoMoNumber = document.getElementById("phone").value;
//     const paymentMethod = document.querySelector(".payment").value;
//     let obj = {
//         key: "pk_test_1a375e4896920a43e7a57b3c7af5798ca3da4dbe",
//         email: userMail,
//         amount: price,
//         mobile_money: {
//             "phone": MoMoNumber,
